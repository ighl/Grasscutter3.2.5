...
{
    private static final Descriptors.Descriptor internal_static_WeekendDjinnInfo_descriptor;
    private static final GeneratedMessageV3.FieldAccessorTable internal_static_WeekendDjinnInfo_fieldAccessorTable;
    ...
    public static Descriptors.FileDescriptor getDescriptor() {
        return WeekendDjinnInfoOuterClass.descriptor;
    }
    
    static {
        final String[] descriptorData = { "\n\u0016WeekendDjinnInfo.proto\u001a\fVector.proto\">\n\u0010WeekendDjinnInfo\u0012\u0014\n\u0003rot\u0018\u000e \u0001(\u000b2\u0007.Vector\u0012\u0014\n\u0003pos\u0018\n \u0001(\u000b2\u0007.VectorB\u001b\n\u0019emu.grasscutter.net.protob\u0006proto3" };
        WeekendDjinnInfoOuterClass.descriptor = Descriptors.FileDescriptor.internalBuildGeneratedFileFrom(descriptorData, new Descriptors.FileDescriptor[] { VectorOuterClass.getDescriptor() });
        internal_static_WeekendDjinnInfo_descriptor = getDescriptor().getMessageTypes().get(0);
        internal_static_WeekendDjinnInfo_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(WeekendDjinnInfoOuterClass.internal_static_WeekendDjinnInfo_descriptor, new String[] { "Rot", "Pos" });
    ...
    public static final class WeekendDjinnInfo extends GeneratedMessageV3 implements WeekendDjinnInfoOrBuilder
    {
        ...
        private static final WeekendDjinnInfo DEFAULT_INSTANCE;
        private static final Parser<WeekendDjinnInfo> PARSER;
        
        private WeekendDjinnInfo(final GeneratedMessageV3.Builder<?> builder) {
            super(builder);
        ...
        private WeekendDjinnInfo(final CodedInputStream input, final ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            this();
        ...
        public boolean equals(final Object obj) {
            ...
            final WeekendDjinnInfo other = (WeekendDjinnInfo)obj;
        ...
        public static WeekendDjinnInfo parseFrom(final ByteBuffer data) throws InvalidProtocolBufferException {
            return WeekendDjinnInfo.PARSER.parseFrom(data);
        }
        
        public static WeekendDjinnInfo parseFrom(final ByteBuffer data, final ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return WeekendDjinnInfo.PARSER.parseFrom(data, extensionRegistry);
        }
        
        public static WeekendDjinnInfo parseFrom(final ByteString data) throws InvalidProtocolBufferException {
            return WeekendDjinnInfo.PARSER.parseFrom(data);
        }
        
        public static WeekendDjinnInfo parseFrom(final ByteString data, final ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return WeekendDjinnInfo.PARSER.parseFrom(data, extensionRegistry);
        }
        
        public static WeekendDjinnInfo parseFrom(final byte[] data) throws InvalidProtocolBufferException {
            return WeekendDjinnInfo.PARSER.parseFrom(data);
        }
        
        public static WeekendDjinnInfo parseFrom(final byte[] data, final ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return WeekendDjinnInfo.PARSER.parseFrom(data, extensionRegistry);
        }
        
        public static WeekendDjinnInfo parseFrom(final InputStream input) throws IOException {
            return GeneratedMessageV3.parseWithIOException(WeekendDjinnInfo.PARSER, input);
        }
        
        public static WeekendDjinnInfo parseFrom(final InputStream input, final ExtensionRegistryLite extensionRegistry) throws IOException {
            return GeneratedMessageV3.parseWithIOException(WeekendDjinnInfo.PARSER, input, extensionRegistry);
        }
        
        public static WeekendDjinnInfo parseDelimitedFrom(final InputStream input) throws IOException {
            return GeneratedMessageV3.parseDelimitedWithIOException(WeekendDjinnInfo.PARSER, input);
        }
        
        public static WeekendDjinnInfo parseDelimitedFrom(final InputStream input, final ExtensionRegistryLite extensionRegistry) throws IOException {
            return GeneratedMessageV3.parseDelimitedWithIOException(WeekendDjinnInfo.PARSER, input, extensionRegistry);
        }
        
        public static WeekendDjinnInfo parseFrom(final CodedInputStream input) throws IOException {
            return GeneratedMessageV3.parseWithIOException(WeekendDjinnInfo.PARSER, input);
        }
        
        public static WeekendDjinnInfo parseFrom(final CodedInputStream input, final ExtensionRegistryLite extensionRegistry) throws IOException {
            return GeneratedMessageV3.parseWithIOException(WeekendDjinnInfo.PARSER, input, extensionRegistry);
        }
        ...
        public static Builder newBuilder() {
            return WeekendDjinnInfo.DEFAULT_INSTANCE.toBuilder();
        }
        
        public static Builder newBuilder(final WeekendDjinnInfo prototype) {
            return WeekendDjinnInfo.DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
        }
        
        @Override
        public Builder toBuilder() {
            return (this == WeekendDjinnInfo.DEFAULT_INSTANCE) ? new Builder() : new Builder().mergeFrom(this);
        }
        ...
        public static WeekendDjinnInfo getDefaultInstance() {
            return WeekendDjinnInfo.DEFAULT_INSTANCE;
        }
        
        public static Parser<WeekendDjinnInfo> parser() {
            return WeekendDjinnInfo.PARSER;
        }
        ...
        static {
            DEFAULT_INSTANCE = new WeekendDjinnInfo();
            PARSER = new AbstractParser<WeekendDjinnInfo>() {
                @Override
                public WeekendDjinnInfo parsePartialFrom(final CodedInputStream input, final ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
        ...
        public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements WeekendDjinnInfoOrBuilder
        {
            ...
            public WeekendDjinnInfo build() {
                final WeekendDjinnInfo result = this.buildPartial();
            ...
            public WeekendDjinnInfo buildPartial() {
                final WeekendDjinnInfo result = new WeekendDjinnInfo(this);
                if (this.rotBuilder_ == null) {
            ...
            public Builder mergeFrom(final Message other) {
                if (other instanceof WeekendDjinnInfo) {
                    return this.mergeFrom((WeekendDjinnInfo)other);
                }
                super.mergeFrom(other);
                return this;
            }
            
            public Builder mergeFrom(final WeekendDjinnInfo other) {
