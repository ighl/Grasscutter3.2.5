...
{
    private static final Descriptors.Descriptor internal_static_CalcWeaponUpgradeReturnItemsReq_descriptor;
    private static final GeneratedMessageV3.FieldAccessorTable internal_static_CalcWeaponUpgradeReturnItemsReq_fieldAccessorTable;
    ...
    public static Descriptors.FileDescriptor getDescriptor() {
        return CalcWeaponUpgradeReturnItemsReqOuterClass.descriptor;
    }
    
    static {
        final String[] descriptorData = { "\n%CalcWeaponUpgradeReturnItemsReq.proto\u001a\u000fItemParam.proto\"\u0081\u0001\n\u001fCalcWeaponUpgradeReturnItemsReq\u0012\u001d\n\u0015food_weapon_guid_list\u0018\u000f \u0003(\u0004\u0012\u001a\n\u0012target_weapon_guid\u0018\f \u0001(\u0004\u0012#\n\u000fitem_param_list\u0018\u0003 \u0003(\u000b2\n.ItemParamB\u001b\n\u0019emu.grasscutter.net.protob\u0006proto3" };
        CalcWeaponUpgradeReturnItemsReqOuterClass.descriptor = Descriptors.FileDescriptor.internalBuildGeneratedFileFrom(descriptorData, new Descriptors.FileDescriptor[] { ItemParamOuterClass.getDescriptor() });
        internal_static_CalcWeaponUpgradeReturnItemsReq_descriptor = getDescriptor().getMessageTypes().get(0);
        internal_static_CalcWeaponUpgradeReturnItemsReq_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(CalcWeaponUpgradeReturnItemsReqOuterClass.internal_static_CalcWeaponUpgradeReturnItemsReq_descriptor, new String[] { "FoodWeaponGuidList", "TargetWeaponGuid", "ItemParamList" });
    ...
    public static final class CalcWeaponUpgradeReturnItemsReq extends GeneratedMessageV3 implements CalcWeaponUpgradeReturnItemsReqOrBuilder
    {
        ...
        private static final CalcWeaponUpgradeReturnItemsReq DEFAULT_INSTANCE;
        private static final Parser<CalcWeaponUpgradeReturnItemsReq> PARSER;
        
        private CalcWeaponUpgradeReturnItemsReq(final GeneratedMessageV3.Builder<?> builder) {
            super(builder);
        ...
        private CalcWeaponUpgradeReturnItemsReq(final CodedInputStream input, final ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            this();
        ...
        protected FieldAccessorTable internalGetFieldAccessorTable() {
            return CalcWeaponUpgradeReturnItemsReqOuterClass.internal_static_CalcWeaponUpgradeReturnItemsReq_fieldAccessorTable.ensureFieldAccessorsInitialized(CalcWeaponUpgradeReturnItemsReq.class, Builder.class);
        }
        ...
        public void writeTo(final CodedOutputStream output) throws IOException {
            ...
            if (this.targetWeaponGuid_ != 0L) {
                output.writeUInt64(12, this.targetWeaponGuid_);
            }
        ...
        public int getSerializedSize() {
            ...
            size = 0;
            for (int i = 0; i < this.itemParamList_.size(); ++i) {
                size += CodedOutputStream.computeMessageSize(3, this.itemParamList_.get(i));
            }
            if (this.targetWeaponGuid_ != 0L) {
                size += CodedOutputStream.computeUInt64Size(12, this.targetWeaponGuid_);
            }
            int dataSize = 0;
            for (int j = 0; j < this.foodWeaponGuidList_.size(); ++j) {
                dataSize += CodedOutputStream.computeUInt64SizeNoTag(this.foodWeaponGuidList_.getLong(j));
            }
            size += dataSize;
        ...
        public boolean equals(final Object obj) {
            ...
            final CalcWeaponUpgradeReturnItemsReq other = (CalcWeaponUpgradeReturnItemsReq)obj;
            return this.getFoodWeaponGuidListList().equals(other.getFoodWeaponGuidListList()) && this.getTargetWeaponGuid() == other.getTargetWeaponGuid() && this.getItemParamListList().equals(other.getItemParamListList()) && this.unknownFields.equals(other.unknownFields);
        }
        ...
        public static CalcWeaponUpgradeReturnItemsReq parseFrom(final ByteBuffer data) throws InvalidProtocolBufferException {
            return CalcWeaponUpgradeReturnItemsReq.PARSER.parseFrom(data);
        }
        
        public static CalcWeaponUpgradeReturnItemsReq parseFrom(final ByteBuffer data, final ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return CalcWeaponUpgradeReturnItemsReq.PARSER.parseFrom(data, extensionRegistry);
        }
        
        public static CalcWeaponUpgradeReturnItemsReq parseFrom(final ByteString data) throws InvalidProtocolBufferException {
            return CalcWeaponUpgradeReturnItemsReq.PARSER.parseFrom(data);
        }
        
        public static CalcWeaponUpgradeReturnItemsReq parseFrom(final ByteString data, final ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return CalcWeaponUpgradeReturnItemsReq.PARSER.parseFrom(data, extensionRegistry);
        }
        
        public static CalcWeaponUpgradeReturnItemsReq parseFrom(final byte[] data) throws InvalidProtocolBufferException {
            return CalcWeaponUpgradeReturnItemsReq.PARSER.parseFrom(data);
        }
        
        public static CalcWeaponUpgradeReturnItemsReq parseFrom(final byte[] data, final ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return CalcWeaponUpgradeReturnItemsReq.PARSER.parseFrom(data, extensionRegistry);
        }
        
        public static CalcWeaponUpgradeReturnItemsReq parseFrom(final InputStream input) throws IOException {
            return GeneratedMessageV3.parseWithIOException(CalcWeaponUpgradeReturnItemsReq.PARSER, input);
        }
        
        public static CalcWeaponUpgradeReturnItemsReq parseFrom(final InputStream input, final ExtensionRegistryLite extensionRegistry) throws IOException {
            return GeneratedMessageV3.parseWithIOException(CalcWeaponUpgradeReturnItemsReq.PARSER, input, extensionRegistry);
        }
        
        public static CalcWeaponUpgradeReturnItemsReq parseDelimitedFrom(final InputStream input) throws IOException {
            return GeneratedMessageV3.parseDelimitedWithIOException(CalcWeaponUpgradeReturnItemsReq.PARSER, input);
        }
        
        public static CalcWeaponUpgradeReturnItemsReq parseDelimitedFrom(final InputStream input, final ExtensionRegistryLite extensionRegistry) throws IOException {
            return GeneratedMessageV3.parseDelimitedWithIOException(CalcWeaponUpgradeReturnItemsReq.PARSER, input, extensionRegistry);
        }
        
        public static CalcWeaponUpgradeReturnItemsReq parseFrom(final CodedInputStream input) throws IOException {
            return GeneratedMessageV3.parseWithIOException(CalcWeaponUpgradeReturnItemsReq.PARSER, input);
        }
        
        public static CalcWeaponUpgradeReturnItemsReq parseFrom(final CodedInputStream input, final ExtensionRegistryLite extensionRegistry) throws IOException {
            return GeneratedMessageV3.parseWithIOException(CalcWeaponUpgradeReturnItemsReq.PARSER, input, extensionRegistry);
        }
        ...
        public static Builder newBuilder() {
            return CalcWeaponUpgradeReturnItemsReq.DEFAULT_INSTANCE.toBuilder();
        }
        
        public static Builder newBuilder(final CalcWeaponUpgradeReturnItemsReq prototype) {
            return CalcWeaponUpgradeReturnItemsReq.DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
        }
        
        @Override
        public Builder toBuilder() {
            return (this == CalcWeaponUpgradeReturnItemsReq.DEFAULT_INSTANCE) ? new Builder() : new Builder().mergeFrom(this);
        }
        ...
        public static CalcWeaponUpgradeReturnItemsReq getDefaultInstance() {
            return CalcWeaponUpgradeReturnItemsReq.DEFAULT_INSTANCE;
        }
        
        public static Parser<CalcWeaponUpgradeReturnItemsReq> parser() {
            return CalcWeaponUpgradeReturnItemsReq.PARSER;
        }
        ...
        static {
            DEFAULT_INSTANCE = new CalcWeaponUpgradeReturnItemsReq();
            PARSER = new AbstractParser<CalcWeaponUpgradeReturnItemsReq>() {
                @Override
                public CalcWeaponUpgradeReturnItemsReq parsePartialFrom(final CodedInputStream input, final ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
        ...
        public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements CalcWeaponUpgradeReturnItemsReqOrBuilder
        {
            ...
            public CalcWeaponUpgradeReturnItemsReq build() {
                final CalcWeaponUpgradeReturnItemsReq result = this.buildPartial();
            ...
            public CalcWeaponUpgradeReturnItemsReq buildPartial() {
                final CalcWeaponUpgradeReturnItemsReq result = new CalcWeaponUpgradeReturnItemsReq(this);
            ...
            public Builder mergeFrom(final Message other) {
                if (other instanceof CalcWeaponUpgradeReturnItemsReq) {
                    return this.mergeFrom((CalcWeaponUpgradeReturnItemsReq)other);
                }
                super.mergeFrom(other);
                return this;
            }
            
            public Builder mergeFrom(final CalcWeaponUpgradeReturnItemsReq other) {
                ...
                if (this.itemParamListBuilder_ == null) {
                    ...
                    if (this.itemParamListBuilder_.isEmpty()) {
                        ...
                        this.itemParamList_ = other.itemParamList_;
                        this.bitField0_ &= 0xFFFFFFFD;
                        this.itemParamListBuilder_ = (CalcWeaponUpgradeReturnItemsReq.alwaysUseFieldBuilders ? this.getItemParamListFieldBuilder() : null);
                    }
                    else {
