...
public final class GachaUpInfoOuterClass {
  ...
  public interface GachaUpInfoOrBuilder extends
    ...
    /**
     * <code>uint32 item_parent_type = 3;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int ITEM_PARENT_TYPE_FIELD_NUMBER = 3;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (itemParentType_ != 0) {
        output.writeUInt32(3, itemParentType_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (itemParentType_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(3, itemParentType_);
      }
      {
        int dataSize = 0;
        for (int i = 0; i < itemIdList_.size(); i++) {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "em_id_list\030\r \003(\r\022\030\n\020item_parent_type\030\003 \001" +
