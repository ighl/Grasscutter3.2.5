...
public final class UnionCmdNotifyOuterClass {
  ...
  public interface UnionCmdNotifyOrBuilder extends
    ...
    /**
     * <code>repeated .UnionCmd cmd_list = 9;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int CMD_LIST_FIELD_NUMBER = 9;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < cmdList_.size(); i++) {
        output.writeMessage(9, cmdList_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < cmdList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(9, cmdList_.get(i));
      }
