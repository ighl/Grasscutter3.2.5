...
public final class ObstacleModifyNotifyOuterClass {
  ...
  public interface ObstacleModifyNotifyOrBuilder extends
    ...
    /**
     * <code>repeated .ObstacleInfo add_obstacles = 11;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int ADD_OBSTACLES_FIELD_NUMBER = 11;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < addObstacles_.size(); i++) {
        output.writeMessage(11, addObstacles_.get(i));
      }
      if (sceneId_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < addObstacles_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(11, addObstacles_.get(i));
      }
      if (sceneId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "obstacles\030\013 \003(\0132\r.ObstacleInfo\022\020\n\010scene_" +
      "id\030\017 \001(\r\022\033\n\023remove_obstacle_ids\030\007 \003(\005B\033\n" +
