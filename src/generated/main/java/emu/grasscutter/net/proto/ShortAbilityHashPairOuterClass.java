...
public final class ShortAbilityHashPairOuterClass {
  ...
  public interface ShortAbilityHashPairOrBuilder extends
    ...
    /**
     * <code>int32 ability_name_hash = 8;</code>
     * @return The abilityNameHash.
     */
    int getAbilityNameHash();

    /**
     * <code>int32 ability_config_hash = 4;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int ABILITY_NAME_HASH_FIELD_NUMBER = 8;
    ...
    public static final int ABILITY_CONFIG_HASH_FIELD_NUMBER = 4;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (abilityConfigHash_ != 0) {
        output.writeInt32(4, abilityConfigHash_);
      }
      if (abilityNameHash_ != 0) {
        output.writeInt32(8, abilityNameHash_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (abilityConfigHash_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeInt32Size(4, abilityConfigHash_);
      }
      if (abilityNameHash_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeInt32Size(8, abilityNameHash_);
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "lityHashPair\022\031\n\021ability_name_hash\030\010 \001(\005\022" +
      "\033\n\023ability_config_hash\030\004 \001(\005B\033\n\031emu.gras" +
