...
public final class WindSeedClientNotifyOuterClass {
  ...
  public interface WindSeedClientNotifyOrBuilder extends
    ...
    /**
     * <code>.WindSeedClientNotify.RefreshNotify refresh_notify = 6;</code>
    ...
    /**
     * <code>.WindSeedClientNotify.AddWindBulletNotify add_wind_bullet_notify = 1;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public interface RefreshNotifyOrBuilder extends
      ...
      /**
       * <code>uint32 refresh_num = 11;</code>
    ...
    private static final long serialVersionUID = 0L;
      ...
      public static final int REFRESH_NUM_FIELD_NUMBER = 11;
      ...
      public void writeTo(com.google.protobuf.CodedOutputStream output)
        ...
        if (refreshNum_ != 0) {
          output.writeUInt32(11, refreshNum_);
        }
      ...
      public int getSerializedSize() {
        ...
        if (refreshNum_ != 0) {
          size += com.google.protobuf.CodedOutputStream
            .computeUInt32Size(11, refreshNum_);
        }
    ...
    public interface AddWindBulletNotifyOrBuilder extends
      ...
      /**
       * <code>.WindSeedClientNotify.Vector seed_pos = 3;</code>
      ...
      /**
       * <code>uint32 catch_player_uid = 13;</code>
       * @return The catchPlayerUid.
       */
      int getCatchPlayerUid();

      /**
       * <code>uint32 seed_entity_id = 12;</code>
    ...
    private static final long serialVersionUID = 0L;
      ...
      public static final int CATCH_PLAYER_UID_FIELD_NUMBER = 13;
      ...
      public static final int SEED_ENTITY_ID_FIELD_NUMBER = 12;
      ...
      public void writeTo(com.google.protobuf.CodedOutputStream output)
        ...
        if (seedEntityId_ != 0) {
          output.writeUInt32(12, seedEntityId_);
        }
        if (catchPlayerUid_ != 0) {
          output.writeUInt32(13, catchPlayerUid_);
        }
        unknownFields.writeTo(output);
      }
      ...
      public int getSerializedSize() {
        ...
        if (seedEntityId_ != 0) {
          size += com.google.protobuf.CodedOutputStream
            .computeUInt32Size(12, seedEntityId_);
        }
        if (catchPlayerUid_ != 0) {
          size += com.google.protobuf.CodedOutputStream
            .computeUInt32Size(13, catchPlayerUid_);
        }
        size += unknownFields.getSerializedSize();
        memoizedSize = size;
        return size;
    ...
    private static final long serialVersionUID = 0L;
      ...
      public void writeTo(com.google.protobuf.CodedOutputStream output)
                          throws java.io.IOException {
        if (areaType_ != 0) {
          output.writeUInt32(4, areaType_);
        }
    ...
    public enum NotifyCase
      ...
      public static NotifyCase forNumber(int value) {
        switch (value) {
          case 6: return REFRESH_NOTIFY;
          case 1: return ADD_WIND_BULLET_NOTIFY;
    ...
    public static final int REFRESH_NOTIFY_FIELD_NUMBER = 6;
    /**
     * <code>.WindSeedClientNotify.RefreshNotify refresh_notify = 6;</code>
     * @return Whether the refreshNotify field is set.
     */
    ...
    public static final int ADD_WIND_BULLET_NOTIFY_FIELD_NUMBER = 1;
    /**
     * <code>.WindSeedClientNotify.AddWindBulletNotify add_wind_bullet_notify = 1;</code>
     * @return Whether the addWindBulletNotify field is set.
     */
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
                        throws java.io.IOException {
      if (notifyCase_ == 1) {
        output.writeMessage(1, (emu.grasscutter.net.proto.WindSeedClientNotifyOuterClass.WindSeedClientNotify.AddWindBulletNotify) notify_);
      }
      if (notifyCase_ == 6) {
        output.writeMessage(6, (emu.grasscutter.net.proto.WindSeedClientNotifyOuterClass.WindSeedClientNotify.RefreshNotify) notify_);
      }
      if (notifyCase_ == 11) {
    ...
    public int getSerializedSize() {
      ...
      if (notifyCase_ == 1) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(1, (emu.grasscutter.net.proto.WindSeedClientNotifyOuterClass.WindSeedClientNotify.AddWindBulletNotify) notify_);
      }
      if (notifyCase_ == 6) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(6, (emu.grasscutter.net.proto.WindSeedClientNotifyOuterClass.WindSeedClientNotify.RefreshNotify) notify_);
      }
      if (notifyCase_ == 11) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public static final class Builder extends
      ...
      @java.lang.Override
      public emu.grasscutter.net.proto.WindSeedClientNotifyOuterClass.WindSeedClientNotify.RefreshNotifyOrBuilder getRefreshNotifyOrBuilder() {
        if ((notifyCase_ == 6) && (refreshNotifyBuilder_ != null)) {
      ...
      @java.lang.Override
      public emu.grasscutter.net.proto.WindSeedClientNotifyOuterClass.WindSeedClientNotify.AddWindBulletNotifyOrBuilder getAddWindBulletNotifyOrBuilder() {
        if ((notifyCase_ == 1) && (addWindBulletNotifyBuilder_ != null)) {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n\032WindSeedClientNotify.proto\"\364\003\n\024WindSee" +
      "dClientNotify\022=\n\016refresh_notify\030\006 \001(\0132#." +
      "WindSeedClientNotify.RefreshNotifyH\000\022K\n\026" +
      "add_wind_bullet_notify\030\001 \001(\0132).WindSeedC" +
      "lientNotify.AddWindBulletNotifyH\000\0227\n\013are" +
      "a_notify\030\013 \001(\0132 .WindSeedClientNotify.Ar" +
      "eaNotifyH\000\032$\n\rRefreshNotify\022\023\n\013refresh_n" +
      "um\030\013 \001(\r\032w\n\023AddWindBulletNotify\022.\n\010seed_" +
      "pos\030\003 \001(\0132\034.WindSeedClientNotify.Vector\022" +
      "\030\n\020catch_player_uid\030\r \001(\r\022\026\n\016seed_entity" +
      "_id\030\014 \001(\r\032C\n\nAreaNotify\022\021\n\tarea_code\030\010 \001" +
      "(\014\022\017\n\007area_id\030\014 \001(\r\022\021\n\tarea_type\030\004 \001(\r\032)" +
