...
public final class AttackHitEffectResultOuterClass {
  ...
  public interface AttackHitEffectResultOrBuilder extends
    ...
    /**
     * <code>float air_strength = 5;</code>
     * @return The airStrength.
     */
    float getAirStrength();

    /**
     * <code>uint32 original_hit_eff_level = 2;</code>
     * @return The originalHitEffLevel.
     */
    int getOriginalHitEffLevel();

    /**
     * <code>float hit_halt_time = 10;</code>
     * @return The hitHaltTime.
     */
    float getHitHaltTime();

    /**
     * <code>uint32 hit_eff_level = 12;</code>
     * @return The hitEffLevel.
     */
    int getHitEffLevel();

    /**
     * <code>float retreat_strength = 11;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int AIR_STRENGTH_FIELD_NUMBER = 5;
    ...
    public static final int ORIGINAL_HIT_EFF_LEVEL_FIELD_NUMBER = 2;
    ...
    public static final int HIT_HALT_TIME_FIELD_NUMBER = 10;
    ...
    public static final int HIT_EFF_LEVEL_FIELD_NUMBER = 12;
    ...
    public static final int RETREAT_STRENGTH_FIELD_NUMBER = 11;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (originalHitEffLevel_ != 0) {
        output.writeUInt32(2, originalHitEffLevel_);
      }
      if (airStrength_ != 0F) {
        output.writeFloat(5, airStrength_);
      }
      if (hitHaltTime_ != 0F) {
        output.writeFloat(10, hitHaltTime_);
      }
      if (retreatStrength_ != 0F) {
        output.writeFloat(11, retreatStrength_);
      }
      if (hitEffLevel_ != 0) {
        output.writeUInt32(12, hitEffLevel_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (originalHitEffLevel_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(2, originalHitEffLevel_);
      }
      if (airStrength_ != 0F) {
        size += com.google.protobuf.CodedOutputStream
          .computeFloatSize(5, airStrength_);
      }
      if (hitHaltTime_ != 0F) {
        size += com.google.protobuf.CodedOutputStream
          .computeFloatSize(10, hitHaltTime_);
      }
      if (retreatStrength_ != 0F) {
        size += com.google.protobuf.CodedOutputStream
          .computeFloatSize(11, retreatStrength_);
      }
      if (hitEffLevel_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(12, hitEffLevel_);
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "HitEffectResult\022\033\n\023hit_halt_time_scale\030\001" +
      " \001(\002\022\024\n\014air_strength\030\005 \001(\002\022\036\n\026original_h" +
      "it_eff_level\030\002 \001(\r\022\025\n\rhit_halt_time\030\n \001(" +
      "\002\022\025\n\rhit_eff_level\030\014 \001(\r\022\030\n\020retreat_stre" +
      "ngth\030\013 \001(\002B\033\n\031emu.grasscutter.net.protob" +
      "\006proto3"
    };
    ...
    internal_static_AttackHitEffectResult_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_AttackHitEffectResult_descriptor,
        new java.lang.String[] { "HitHaltTimeScale", "AirStrength", "OriginalHitEffLevel", "HitHaltTime", "HitEffLevel", "RetreatStrength", });
  }
