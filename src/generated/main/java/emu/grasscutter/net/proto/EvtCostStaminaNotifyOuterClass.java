...
public final class EvtCostStaminaNotifyOuterClass {
  ...
  public interface EvtCostStaminaNotifyOrBuilder extends
    ...
    /**
     * <code>float cost_stamina = 1;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int COST_STAMINA_FIELD_NUMBER = 1;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (costStamina_ != 0F) {
        output.writeFloat(1, costStamina_);
      }
      if (skillId_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      if (costStamina_ != 0F) {
        size += com.google.protobuf.CodedOutputStream
          .computeFloatSize(1, costStamina_);
      }
      if (skillId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "taminaNotify\022\020\n\010skill_id\030\005 \001(\r\022\024\n\014cost_s" +
      "tamina\030\001 \001(\002B\033\n\031emu.grasscutter.net.prot" +
      "ob\006proto3"
    };
