...
public final class AuthorityChangeOuterClass {
  ...
  public interface AuthorityChangeOrBuilder extends
    ...
    /**
     * <code>uint32 authority_peer_id = 11;</code>
     * @return The authorityPeerId.
     */
    int getAuthorityPeerId();

    /**
     * <code>.EntityAuthorityInfo entity_authority_info = 6;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int AUTHORITY_PEER_ID_FIELD_NUMBER = 11;
    ...
    public static final int ENTITY_AUTHORITY_INFO_FIELD_NUMBER = 6;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (entityAuthorityInfo_ != null) {
        output.writeMessage(6, getEntityAuthorityInfo());
      }
      if (authorityPeerId_ != 0) {
        output.writeUInt32(11, authorityPeerId_);
      }
      if (entityId_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      if (entityAuthorityInfo_ != null) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(6, getEntityAuthorityInfo());
      }
      if (authorityPeerId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(11, authorityPeerId_);
      }
      if (entityId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ty_peer_id\030\013 \001(\r\0223\n\025entity_authority_inf" +
      "o\030\006 \001(\0132\024.EntityAuthorityInfo\022\021\n\tentity_" +
