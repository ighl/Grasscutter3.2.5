...
{
    private static final Descriptors.Descriptor internal_static_GetPlayerAskFriendListRsp_descriptor;
    private static final GeneratedMessageV3.FieldAccessorTable internal_static_GetPlayerAskFriendListRsp_fieldAccessorTable;
    ...
    public static Descriptors.FileDescriptor getDescriptor() {
        return GetPlayerAskFriendListRspOuterClass.descriptor;
    }
    
    static {
        final String[] descriptorData = { "\n\u001fGetPlayerAskFriendListRsp.proto\u001a\u0011FriendBrief.proto\"S\n\u0019GetPlayerAskFriendListRsp\u0012\u000f\n\u0007retcode\u0018\r \u0001(\u0005\u0012%\n\u000fask_friend_list\u0018\u000f \u0003(\u000b2\f.FriendBriefB\u001b\n\u0019emu.grasscutter.net.protob\u0006proto3" };
        GetPlayerAskFriendListRspOuterClass.descriptor = Descriptors.FileDescriptor.internalBuildGeneratedFileFrom(descriptorData, new Descriptors.FileDescriptor[] { FriendBriefOuterClass.getDescriptor() });
        internal_static_GetPlayerAskFriendListRsp_descriptor = getDescriptor().getMessageTypes().get(0);
        internal_static_GetPlayerAskFriendListRsp_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(GetPlayerAskFriendListRspOuterClass.internal_static_GetPlayerAskFriendListRsp_descriptor, new String[] { "Retcode", "AskFriendList" });
    ...
    public static final class GetPlayerAskFriendListRsp extends GeneratedMessageV3 implements GetPlayerAskFriendListRspOrBuilder
    {
        ...
        private static final Parser<GetPlayerAskFriendListRsp> PARSER;
        
        private GetPlayerAskFriendListRsp(final GeneratedMessageV3.Builder<?> builder) {
            super(builder);
        ...
        private GetPlayerAskFriendListRsp(final CodedInputStream input, final ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            this();
        ...
        public void writeTo(final CodedOutputStream output) throws IOException {
            ...
            for (int i = 0; i < this.askFriendList_.size(); ++i) {
                output.writeMessage(15, this.askFriendList_.get(i));
            }
        ...
        public int getSerializedSize() {
            ...
            for (int i = 0; i < this.askFriendList_.size(); ++i) {
                size += CodedOutputStream.computeMessageSize(15, this.askFriendList_.get(i));
            }
        ...
        public boolean equals(final Object obj) {
            ...
            final GetPlayerAskFriendListRsp other = (GetPlayerAskFriendListRsp)obj;
            return this.getRetcode() == other.getRetcode() && this.getAskFriendListList().equals(other.getAskFriendListList()) && this.unknownFields.equals(other.unknownFields);
        }
        ...
        public static GetPlayerAskFriendListRsp parseFrom(final ByteBuffer data) throws InvalidProtocolBufferException {
            return GetPlayerAskFriendListRsp.PARSER.parseFrom(data);
        }
        
        public static GetPlayerAskFriendListRsp parseFrom(final ByteBuffer data, final ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return GetPlayerAskFriendListRsp.PARSER.parseFrom(data, extensionRegistry);
        }
        
        public static GetPlayerAskFriendListRsp parseFrom(final ByteString data) throws InvalidProtocolBufferException {
            return GetPlayerAskFriendListRsp.PARSER.parseFrom(data);
        }
        
        public static GetPlayerAskFriendListRsp parseFrom(final ByteString data, final ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return GetPlayerAskFriendListRsp.PARSER.parseFrom(data, extensionRegistry);
        }
        
        public static GetPlayerAskFriendListRsp parseFrom(final byte[] data) throws InvalidProtocolBufferException {
            return GetPlayerAskFriendListRsp.PARSER.parseFrom(data);
        }
        
        public static GetPlayerAskFriendListRsp parseFrom(final byte[] data, final ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return GetPlayerAskFriendListRsp.PARSER.parseFrom(data, extensionRegistry);
        }
        
        public static GetPlayerAskFriendListRsp parseFrom(final InputStream input) throws IOException {
            return GeneratedMessageV3.parseWithIOException(GetPlayerAskFriendListRsp.PARSER, input);
        }
        
        public static GetPlayerAskFriendListRsp parseFrom(final InputStream input, final ExtensionRegistryLite extensionRegistry) throws IOException {
            return GeneratedMessageV3.parseWithIOException(GetPlayerAskFriendListRsp.PARSER, input, extensionRegistry);
        }
        
        public static GetPlayerAskFriendListRsp parseDelimitedFrom(final InputStream input) throws IOException {
            return GeneratedMessageV3.parseDelimitedWithIOException(GetPlayerAskFriendListRsp.PARSER, input);
        }
        
        public static GetPlayerAskFriendListRsp parseDelimitedFrom(final InputStream input, final ExtensionRegistryLite extensionRegistry) throws IOException {
            return GeneratedMessageV3.parseDelimitedWithIOException(GetPlayerAskFriendListRsp.PARSER, input, extensionRegistry);
        }
        
        public static GetPlayerAskFriendListRsp parseFrom(final CodedInputStream input) throws IOException {
            return GeneratedMessageV3.parseWithIOException(GetPlayerAskFriendListRsp.PARSER, input);
        }
        
        public static GetPlayerAskFriendListRsp parseFrom(final CodedInputStream input, final ExtensionRegistryLite extensionRegistry) throws IOException {
            return GeneratedMessageV3.parseWithIOException(GetPlayerAskFriendListRsp.PARSER, input, extensionRegistry);
        }
        ...
        public static Builder newBuilder() {
            return GetPlayerAskFriendListRsp.DEFAULT_INSTANCE.toBuilder();
        }
        
        public static Builder newBuilder(final GetPlayerAskFriendListRsp prototype) {
            return GetPlayerAskFriendListRsp.DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
        }
        
        @Override
        public Builder toBuilder() {
            return (this == GetPlayerAskFriendListRsp.DEFAULT_INSTANCE) ? new Builder() : new Builder().mergeFrom(this);
        }
        ...
        public static GetPlayerAskFriendListRsp getDefaultInstance() {
            return GetPlayerAskFriendListRsp.DEFAULT_INSTANCE;
        }
        
        public static Parser<GetPlayerAskFriendListRsp> parser() {
            return GetPlayerAskFriendListRsp.PARSER;
        }
        ...
        static {
            ...
            PARSER = new AbstractParser<GetPlayerAskFriendListRsp>() {
                @Override
                public GetPlayerAskFriendListRsp parsePartialFrom(final CodedInputStream input, final ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
        ...
        public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements GetPlayerAskFriendListRspOrBuilder
        {
            ...
            public GetPlayerAskFriendListRsp build() {
                final GetPlayerAskFriendListRsp result = this.buildPartial();
            ...
            public GetPlayerAskFriendListRsp buildPartial() {
                final GetPlayerAskFriendListRsp result = new GetPlayerAskFriendListRsp(this);
            ...
            public Builder mergeFrom(final Message other) {
                if (other instanceof GetPlayerAskFriendListRsp) {
                    return this.mergeFrom((GetPlayerAskFriendListRsp)other);
                }
                super.mergeFrom(other);
                return this;
            }
            
            public Builder mergeFrom(final GetPlayerAskFriendListRsp other) {
                ...
                if (this.askFriendListBuilder_ == null) {
                    ...
                    if (this.askFriendListBuilder_.isEmpty()) {
                        ...
                        this.askFriendList_ = other.askFriendList_;
                        this.bitField0_ &= 0xFFFFFFFE;
                        this.askFriendListBuilder_ = (GetPlayerAskFriendListRsp.alwaysUseFieldBuilders ? this.getAskFriendListFieldBuilder() : null);
                    }
                    else {
